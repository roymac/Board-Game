...
public class GPG_CloudSaveSystem : MonoBehaviour{
...
//	
	...
	public void SaveToCloud(string key) 
	{
		if (Authenticated) 
		{
			Debug.Log("Saving progress to the cloud... filename: " + key);
			m_saving = true;
			//save to named file
			((PlayGamesPlatform)Social.Active).SavedGame.OpenWithAutomaticConflictResolution(
